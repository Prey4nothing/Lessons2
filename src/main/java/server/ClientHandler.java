    ...
    private void readMessages() throws IOException {
        while (true) {
            ...
            if(messageInChat.equals(ServerCommandConstants.SHUTDOWN)) {
                return;
            } else if (messageInChat.contains(ServerCommandConstants.Whisper)) {
                String receiver = messageInChat.split(" ")[1];
                String message = messageInChat.split(" ")[2];
                server.broadcastMessage(this ,receiver,message);
            } else {
